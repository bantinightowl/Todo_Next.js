  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-2xl max-w-md w-full p-6 animate-scale-in">
        ...
        <p className="text-gray-600 dark:text-gray-300 mb-6 ml-14">{message}</p>
        
        <div className="flex space-x-3 ml-14">
          <button
            onClick={onCancel}
            className="flex-1 px-4 py-2 bg-gray-200 dark:bg-slate-600 text-gray-800 dark:text-white rounded-lg hover:bg-gray-300 dark:hover:bg-slate-500 transition duration-200 font-medium"
          >
            No
          </button>
          <button
